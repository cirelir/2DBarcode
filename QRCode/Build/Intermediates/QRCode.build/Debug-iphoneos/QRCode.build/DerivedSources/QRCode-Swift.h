...
SWIFT_CLASS("_TtC6QRCode11AppDelegate")
...
SWIFT_CLASS("_TtC6QRCode21ScannerBackgroundView")
@interface ScannerBackgroundView : UIView
@property (nonatomic, readonly, strong) UIView * _Nonnull barcodeView;
@property (nonatomic, readonly, strong) UIImageView * _Nonnull scanLine;
@property (nonatomic, copy) NSString * _Null_unspecified scanning;
...
@property (nonatomic, readonly, strong) ScannerBackgroundView * _Nonnull cameraView;
...
SWIFT_CLASS("_TtC6QRCode14ViewController")
